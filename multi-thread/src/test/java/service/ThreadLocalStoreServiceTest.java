...
@DisplayName("Thread Local을 사용한 동시성 테스트")
class ThreadLocalStoreServiceTest {

    private ThreadLocalStoreService storeService;

    @BeforeEach
    public void init() {
        this.storeService = new ThreadLocalStoreService();
    }
